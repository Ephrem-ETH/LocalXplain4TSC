...
def generate_perturbations(original_time_series, num_perturbations, replacement_method='zero'):
    ...
    for _ in range(num_perturbations):
        ...
        perturbed_time_series = perturb_time_series(original_time_series, num_masked_segments, max_consecutive_steps, replacement_method)
        # Append perturbed time series to the list
        perturbed_list.append(perturbed_time_series)
